...
class NewCarActivity : AppCompatActivity() , OnMapReadyCallback {
    ...
    private fun saveData() {
        ...
        } ?: throw IllegalArgumentException("Usuário deveria ter a localização aqui .")
            ...
            withContext(Dispatchers.Main) {
                when (result) {
                    ...
                    is Result.Success -> {
                        Toast.makeText(
                            this@NewCarActivity,
                            getString(R.string.succes_create_car, carName),
                            Toast.LENGTH_SHORT
                        ).show()
                        finish()
                    }
    ...
    private fun validateForm(): Boolean {
        ...
        if (selectedMarker == null) {
            Toast.makeText(this, getString(R.string.error_validate_location), Toast.LENGTH_SHORT)
                .show()
            return false
        }
